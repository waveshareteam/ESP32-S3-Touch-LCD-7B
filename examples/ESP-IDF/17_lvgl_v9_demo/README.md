...
本示例演示 `ESP32-S3-Touch-LCD-7B` 的 `LVGL 9` 移植结果。程序完成 RGB LCD、GT911 触摸和 `esp_lvgl_adapter` 初始化后，默认运行 `lv_demo_widgets()` 官方示例界面。
...
- 保留 `7B` 原有 `rgb_lcd_port` 和 `gt911/touch` 硬件链路
- 移除旧 `LVGL8 lvgl_port` 组件
- 主流程改为 `LVGL 9 + esp_lvgl_adapter`
